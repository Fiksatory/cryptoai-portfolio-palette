...
const AiDashboard = () => {
  ...
  const renderContent = () => {
    ...
    const tokenGatedBadge = (
      <div className="flex items-center gap-2 text-xl font-medium text-gray-800 bg-white/90 backdrop-blur-3xl px-6 py-3 rounded-full border border-white/60 shadow-lg">
